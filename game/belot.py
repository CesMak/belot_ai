...
#The value of the cards in the trump card
valuesTrump = {
    Rank.VII:    0,
    Rank.VIII:   0,
    Rank.IX:    14,
...
def dealCards():
    ...
    for i in range(0, 4):
        ...
        deck -= set(cards1)
        player_cards.append(cards1)
        print("Player ",i+1, "Cards:", cards1, "\n")

    return player_cards[0], player_cards[1], player_cards[2], player_cards[3]
